...
namespace Examen.GestionLibros.API.Controllers
{
    ...
    {
        private readonly IAutorNegocio _Repositorio;
        public AutorController(IAutorNegocio Repositorio)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Post(AutorRequest request)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, AutorRequest request)
        {
